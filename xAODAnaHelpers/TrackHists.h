...
class TrackHists : public HistogramManager
{
  ...
  private:
    ...
    TH1D* m_trk_z0sinT; //!
    TH1D* m_trk_z0sinT_l; //!
    TH1D* m_trk_z0SigsinT; //!
    TH1D* m_trk_chi2Prob_l; //!
    TH1D* m_trk_chi2Prob_s; //!
    TH1D* m_trk_chi2Prob_ss; //!
    TH1D* m_trk_chi2ndof; //!
    TH1D* m_trk_chi2ndof_l; //!
    TH1D* m_trk_nSi; //!
    ...
    TH1D* m_trk_qOpErr; //!
    TH1D* m_trk_mc_prob; //!
    TH1D* m_trk_mc_barcode; //!
    TH1D* m_trk_mc_barcode_s; //!
    TH1D* m_trk_eta_vl; //!
    TH1D* m_trk_z0_vl; //!
    TH1D* m_trk_z0_m; //!
    TH1D* m_trk_z0_raw_m; //!
    TH1D* m_trk_vz; //!
    TH1D* m_trk_z0_atlas_m; //!
    TH1D* m_trk_d0_vl; //!
    TH1D* m_trk_pt_ss; //!
    TH1D* m_trk_phiManyBins; //!
