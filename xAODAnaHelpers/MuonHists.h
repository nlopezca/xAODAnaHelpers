...
class MuonHists : public IParticleHists
{
  ...
  private:
    ...
    // Isolation
    std::map<std::string, TH1D *> m_isIsolated; //!
    ...
    TH1D* m_ptcone30_rel				   ; //!
    TH1D* m_ptcone40_rel				   ; //!
    TH1D* m_ptvarcone20_rel				   ; //!
    TH1D* m_ptvarcone30_rel				   ; //!
    TH1D* m_ptvarcone40_rel				   ; //!
    TH1D* m_topoetcone20_rel			   ; //!
    TH1D* m_topoetcone30_rel			   ; //!
    TH1D* m_topoetcone40_rel			   ; //!


    // quality
    std::map<std::string, TH1D *> m_quality; //!
